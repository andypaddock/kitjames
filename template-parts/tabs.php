                ...
                while ( have_rows('content') ) : the_row();?>
                        ...
                        <div class="team-list">
                            ...
                            <div class="team-list__item">
                                ...
                                <div class="detail">
                                    <h2 class="heading-secondary"><?php the_sub_field('name');?></h3>
                                        <h3 class="pub-date"><?php the_sub_field('position');?></h3>
                        ...
                        <div class="head">
                            <h3 class="heading-secondary"><?php the_sub_field('toggle_heading');?></h3>
                        ...
                        if( have_rows('toggle_item') ):
                            ...
                            <div class="toggle-list__item js-toggle-parent">
                                <div class="head js-toggle-trigger">
                                    <p>0<?= $t;?></p>
                                    <h4 class="heading-secondary alt-font"><?php the_sub_field('heading');?></h4>
                                </div>
                    ...
                    $ctaImage = get_sub_field('background_image');?>
                        <div class="image-cta">
                            ...
                            <a href="<?php the_sub_field('button_target');?>" target="_blank"
                                class="button button__boxed">
